...
public class RedPlatform extends AbstractGameObject implements IPlatform {

    private static final float MOVE_SPEED = 2.2f;
    private static final float MAX_MOVEMENT_DURATION = 1.5f;
    private float moveTimer;
    private int direction;

    public RedPlatform(Texture spriteSheet, float x, float y) {
